...
namespace Red_Neuronal
{
    ...
    /// </summary>
    class Red_Neuronal_BackPropagation
    {
        //Variables globales
        ...
        public Red_Neuronal_BackPropagation(int cantEntrada, int cantOculta, int cantSalida)
        {
            ...
            valores_capa_entrada = new double[cantEntrada + 1];                 //Inicializa los vectores de las salidas de las capas, agrega uno por el umbral
            valores_capa_oculta = new double[cantOculta +1];                    
            valores_capa_salida = new double[cantSalida + 1];
            pesos_capa_oculta = new double[cantEntrada + 1, cantOculta + 1];    //Inicializa las matrices de pesos. agrega uno por el umbral
            pesos_capa_salida = new double[cantOculta + 1, cantSalida + 1];     
        }
