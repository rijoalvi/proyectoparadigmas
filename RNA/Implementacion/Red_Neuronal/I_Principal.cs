...
namespace Red_Neuronal
{
    public partial class I_Principal : Form
    {
        ...
        {
            panel_muestra_entrenamiento.Visible = panel_ejecucion.Visible = panel_crear_muestras.Visible = panel_entrenamiento_bp.Visible = false;
        ...
        private void menu_ejecucion_Click(object sender, EventArgs e)
        {
            ...
            panel_entrenamiento_bp.Visible = panel_crear_muestras.Visible = panel_muestra_entrenamiento.Visible = false;
        ...
        private void boton_reconocer_figura_Click(object sender, EventArgs e)
        {
            ...
            campo_resultado_ejecucion_bp.Text = reconocer_codificacion(resultado);  //Obtiene la figura resultante segun la codificacion
        }
        ...
        {
            panel_ejecucion.Visible = panel_entrenamiento_bp.Visible = panel_muestra_entrenamiento.Visible = false;
